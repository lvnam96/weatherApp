  ...
  (function gettingJSON() {//geryle.me is a non-SSL certificated domain, so it can't get geolocation
    ...
    if(navigator.geolocation) {
      navigator.geolocation.getCurrentPosition(function(position) {
        var userGPSURL = 'http://api.openweathermap.org/data/2.5/weather?lat=' + position.coords.latitude + '&lon=' + position.coords.longitude + '&units=metric&appid=23e9fc4d419a0d4f321a5d0cc3735b6a';
        var request = new XMLHttpRequest();
